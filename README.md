# Projet Système de commande en ligne mutli-marché
Projet Java — Licence MIAGE

---

## Objectif
Réaliser un système de commande en ligne multi-marché avec Java en utilisant les design pattern suivants : Factory et Builder.
